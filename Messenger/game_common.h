...
namespace Game {
    ...
    RenderCommand<uint16_t>* drawCenteredSprite(int x,int y,SpriteSheetRect rect, bool mirror);
    RenderCommand<uint16_t>* drawSprite(int x,int y,SpriteSheetRect rect, bool mirr);

    void spawnEnemySwordFighter(int x, int y, int offsets);
}
